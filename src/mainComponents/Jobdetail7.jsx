...
export default function Jobdetail7() {
  return (
    <>
      {/* header */}
      ...
      <center>
        ...
        <div className="jobdetail" style={{ height: "800px" }}>
          <div className="jobname">Software Development Internship</div>
          <div className="jobdescription">
            <div className="jobtype">
              ...
              <div className="jobinfo-detail">
                ...
                <div className="jobinfo-desc">
                  Job Type:
                  <p className="employeetype">Software Development Intern</p>
                </div>
              </div>
              <div className="jobinfo-detail">
                <div className="jobinfo-icon">
            ...
            <div className="jobcontent">
              ...
              <div className="jobtitle-desc">
                We are happy to inform you that we are conducting an internship
                program for freshers. This is a Software Development internship
                where on successful completion of internship students will get
                certification.<br/>This is a 3 Months program.
              </div>

...
export default function Jobdetail9() {
  return (
    <>
      {/* header */}
      ...
      <center>
        ...
        <div className="jobdetail" style={{ height: "750px" }}>
          <div className="jobname">Human Resource</div>
          <div className="jobdescription">
            <div className="jobtype">
              ...
              <div className="jobinfo-detail">
                ...
                <div className="jobinfo-desc">
                  Job Type:
                  <p className="employeetype">Human Resource</p>
                </div>
              </div>
              <div className="jobinfo-detail">
                <div className="jobinfo-icon">
            ...
            <div className="jobcontent">
              ...
              <div className="jobtitle-desc">
                <ul>
                    <li>Work on end to end recruitment process.</li>
                    <li>Work on induction and onboarding.</li>
                    <li>Assist in screening forms and resumes of applicants.</li>
                    <li>Plan and schedule interviews with candidates.</li>
                    <li>Manage job advertisements on job portals and social networks.</li>
                </ul>
              </div>
              ...
              <div className="jobtitle-desc1">
                <ul>
                  ...
                  <li>Short listing resumes based on several search. </li>
                </ul>
              </div>
              ...
              Bachelor's or Master’s degree in Human Resources Management or similar field<br/>Must be available for duration of 3 months
              </div>
              <div className="jobtitle2">
              ...
              <div className="jobtitle-desc2">
                <ul>
                  <li>Knowledge on recruitment concepts.</li>
